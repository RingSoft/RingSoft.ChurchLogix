    ...
    public partial class Groups : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StaffPersonId = table.Column<int>(type: "integer", nullable: false),
                    GroupId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StaffGroups", x => new { x.StaffPersonId, x.GroupId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_StaffGroups_Staff_StaffPersonId",
